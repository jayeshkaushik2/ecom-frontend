...
const HomeHeader = (props) => {
  ...
  return (
    ...
    >
      ...
      props.HomepageData["images"]?.length > 0 ? (
        <Box height="inherit">
          <Box
            sx={{
              position: "absolute",
              ...
              color: `${
                props.HomepageData.images[CurrentImageIndex].is_dark === true
                  ? "white"
                  : "black"
              }`,
            }}
          >
            ...
            <Typography sx={{ textAlign: "center" }}>
              {props.HomepageData?.description
                ? props.HomepageData.description
                : "Description"}
            </Typography>
          </Box>
          <img
            ...
            height="100%"
            src={
              props.HomepageData["images"]?.length >= CurrentImageIndex
                ? `${API_ENDPOINT}${props.HomepageData["images"][CurrentImageIndex]?.image}`
                : defaultImage
            }
            alt="homepage image"
          />
