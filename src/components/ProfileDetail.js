        ...
        <Box>
            ...
            >
                ...
                <DialogContent dividers>
                    <input type="file" lable="upload profile image" onChange={(e) => setProfileImage(e.target.value)}>
                    </input>
                    <input type="file" lable="upload profile image" onChange={(e) => setBannerImage(e.target.value)}>
                    </input>
                    {/* <TextField
                        margin="normal"
                        required
